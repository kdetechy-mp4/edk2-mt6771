...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PrePi";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gArmMmuReplaceLiveTranslationEntryFuncGuid = { 0xa8b50ff3, 0x08ec, 0x4dd3, {0xbf, 0x04, 0x28, 0xbf, 0x71, 0x75, 0xc7, 0x4a} };
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdPrePiStackBase = _PCD_VALUE_PcdPrePiStackBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdPrePiStackSize = _PCD_VALUE_PcdPrePiStackSize;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdUefiMemPoolBase = _PCD_VALUE_PcdUefiMemPoolBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdUefiMemPoolSize = _PCD_VALUE_PcdUefiMemPoolSize;
